...
import 'app/administrative_dashboard/administrative_dashboard_layout.dart' as a2;
...
List<RouteEntity> get routes => [
  ...
  RouteEntity(
    key: '/administrative_dashboard',
    uri: Uri.parse('/administrative_dashboard'),
    routeBuilder: (ctx, settings) => Routefly.defaultRouteBuilder(
      ctx,
      settings,
  ...
  RouteEntity(
    ...
    parent: '/administrative_dashboard',
